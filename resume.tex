...
\begin{itemize}
    \item Designed and implemented number masking feature; \vspace{-6pt}
    \item Designed and implemented in-app chat service, which serves {\bf 100k} messages per second. \vspace{-6pt}
\end{itemize}
